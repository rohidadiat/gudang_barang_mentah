...
<body>
    ...
    <div class="col px-5 mx-4 justify-content-center rounded shadow p-3 mb-5 bg-body-tertiary">
			<h2 style="text-align: center;" class="text-secondary"><i class="fa-solid fa-truck"></i> List Pengiriman</h2>
			<hr class="my-4">
			<?= $this->session->flashdata('msg') ?>

        <div class="navbar">
          <div class="col-md-3 navbar">
            <button class="btn btn-success"><a href="<?= site_url('pengiriman/add'); ?>" class="text-white" style="text-decoration: none;"><i class="fa-solid fa-plus"></i> Add</a></button>
          </div>
          ...
          <div class="col-md-3 navbar-right">
            <form class="d-flex" action="<?= site_url('pengiriman/search'); ?>" method="post">
							<div class="input-group">
        ...
        <?php foreach ($pengiriman as $data) { ?>
            <tr>
                ...
                <td><?=$data->id_permintaan_barang?></td>
                <td><?=$data->tanggal_pengiriman?></td>
                <td><?=$data->stok_terkirim?></td>

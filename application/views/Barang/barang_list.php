...
<body>
    ...
    <div class="col px-5 mx-4 justify-content-center rounded shadow p-3 mb-5 bg-body-tertiary">
			<h2 style="text-align: center;" class="text-secondary"><i class="fa-solid fa-store"></i> List Barang</h2>
				<hr class="my-4">
				<?= $this->session->flashdata('msg') ?>
				
				<div class="navbar">
					<div class="col-md-3 navbar">
						<button class="btn btn-success"><a href="<?= site_url('barang/add'); ?>" class="text-white" style="text-decoration: none;"><i class="fa-solid fa-plus"></i> Add</a></button>
					</div>
					...
					<div class="col-md-3 navbar-right">
						<form class="d-flex" action="<?= site_url('barang/search'); ?>" method="post">
							<div class="input-group">
			...
			<table class="table table-striped table-bordered">
				...
				<tbody class="table-group-divider">
					...
					<tr>
						...
						<td align="center"><a href="<?=site_url('barang/edit/'.$data->id_barang)?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square text-white"></i></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
